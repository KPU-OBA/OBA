...
extern "C" {
    ...
    JNIEXPORT jint JNICALL Java_gui_english_1level1_Send_1route
    (JNIEnv *env, jclass cls, jintArray ji_route)
    {
        ...
        int main(){
            ...
            while(1)
            {
                ...
                if (digitalRead(button_Pin)) // Button is released if this returns 1
                {
                    printf("button On ! ! ! \n");
                }
