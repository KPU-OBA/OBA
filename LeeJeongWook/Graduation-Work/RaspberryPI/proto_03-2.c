...
int main(){
    ...
    while(1)
	{
        ...
        if (digitalRead(button_Pin) == 0) // Button is released if this returns 1
        {
            printf("button On ! ! ! \n");
            printf("==================\n");
            printf("ch1_1:%d\n",val1_1);
            ...
            if(val3_1 < 200)
            {
                ...
                {
                    route[2] = Left;
                    printf("Section_03: Left\n");
                }
                else if(val3_3 <200)
                {
                    route[2] = Function;
                    printf("Section_03: Function\n");
                }
                else
                {
                    route[2] = Up;
                    printf("Section_03: Up\n");
                }
            }
            else if(val3_2 < 200)
            {
                route[2] = Down;
                printf("Section_03: Down\n");
            }
            else if(val3_3 < 200)
            {
                route[2] = Right;
                printf("Section_03: Right\n");
            }
            else
            {
                printf("Put Block in Section_03\n");
            }
            ...
            if(val4_1 < 200)
            {
                ...
                {
                    route[3] = Left;
                    printf("Section_04: Left\n");
                }
                else if(val4_3 <200)
                {
                    route[3] = Function;
                    printf("Section_04: Function\n");
                }
                else
                {
                    route[3] = Up;
                    printf("Section_04: Up\n");
                }
            }
            else if(val4_2 < 200)
            {
                route[3] = Down;
                printf("Section_04: Down\n");
            }
            else if(val4_3 < 200)
            {
                route[3] = Right;
                printf("Section_04: Right\n");
            }
            else
            {
                printf("Put Block in Section_04\n");
            }
            ...
            if(val5_1 < 200)
            {
                ...
                {
                    route[4] = Left;
                    printf("Section_05: Left\n");
                }
                else if(val5_3 <200)
                {
                    route[4] = Function;
                    printf("Section_05: Function\n");
                }
                else
                {
                    route[4] = Up;
                    printf("Section_05: Up\n");
                }
            }
            else if(val5_2 < 200)
            {
                route[4] = Down;
                printf("Section_05: Down\n");
            }
            else if(val5_3 < 200)
            {
                route[4] = Right;
                printf("Section_05: Right\n");
            }
            else
            {
                printf("Put Block in Section_05\n");
            }
